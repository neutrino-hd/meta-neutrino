...
do_install () {
	install -d ${D}/usr/share/tuxbox/plugins/rss_addon
	...
	install -m 644 ${S}/rss_icon.png ${D}/usr/share/tuxbox/plugins
	install -m 644 ${S}/rssreader.conf ${D}/usr/share/tuxbox/plugins
}
