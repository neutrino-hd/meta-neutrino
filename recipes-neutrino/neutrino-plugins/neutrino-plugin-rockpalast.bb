...
do_install () {
	...
	install -m 644 ${S}/rockpalast.cfg ${D}/usr/share/tuxbox/neutrino/plugins
	install -m 644 ${S}/rockpalast.lua ${D}/usr/share/tuxbox/neutrino/plugins
	install -m 644 ${S}/rockpalast_hint.png ${D}/usr/share/tuxbox/neutrino/plugins
}
